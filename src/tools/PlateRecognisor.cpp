...
void PlateRecognisor::recognizePlateInDirectory(const QString& path) {
    ...
    recognizePlateInDirectory(list);

}

void PlateRecognisor::recognizePlateInDirectory(QFileInfoList & infoList) {
